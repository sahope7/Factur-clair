        ...
        (err, details) => {
          ...
          details.forEach((detail) => {
            ...
            doc.fillColor('#2c3e50')
               ...
               .text(`${detail.prix_unitaire.toFixed(2)} €`, 350, yPosition)
               .text(`${detail.tva}%`, 420, yPosition)
               .text(`${montantHT.toFixed(2)} €`, 470, yPosition);
          ...
          doc.fontSize(10)
             ...
             .text(`${facture.total_ht.toFixed(2)} €`, 470, yPosition, { align: 'right' });

          yPosition += 20;
          doc.text('Total TVA:', 400, yPosition)
             .text(`${facture.total_tva.toFixed(2)} €`, 470, yPosition, { align: 'right' });

          yPosition += 20;
          doc.fontSize(12)
             .fillColor('#27ae60')
             .text('Total TTC:', 400, yPosition)
             .text(`${facture.total_ttc.toFixed(2)} €`, 470, yPosition, { align: 'right' });
